...
class DeltaStarWidget(ttk.Panedwindow):
    def __init__(self, master=None, **kw):
        ...
        self.ent_R2.configure(exportselection="true", justify="left", width=8)
        _text_ = 'R2'
